...
pub fn tool_worktree_create() -> Value {
    json!({
        "name": "euri_worktree_create",
        "description": "Create a git worktree for a work item. Creates branch euri/{callsign} and registers the worktree directory.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "project_id":  { "type": "string", "description": "Project ID" },
                "callsign":    { "type": "string", "description": "Work item callsign (e.g. EURI-58)" },
...
pub fn handle_worktree_create(input: Value) -> Result<String> {
    ...
    let branch_name = format!("euri/{}", callsign.to_lowercase());
