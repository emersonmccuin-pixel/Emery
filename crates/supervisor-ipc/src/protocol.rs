...
impl Method {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ProjectEnsureCommandCenter => "project.ensure_command_center",
            Self::NamespaceSuggest => "namespace.suggest",
            ...
            Self::WorktreeProvision => "worktree.provision",
            Self::WorktreeUpdate => "worktree.update",
            Self::WorktreeClose => "worktree.close",
            Self::WorktreeReorder => "worktree.reorder",
...
impl TryFrom<&str> for Method {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            ...
            "project.ensure_command_center" => Ok(Self::ProjectEnsureCommandCenter),
            "namespace.suggest" => Ok(Self::NamespaceSuggest),
            ...
            "worktree.provision" => Ok(Self::WorktreeProvision),
            "worktree.update" => Ok(Self::WorktreeUpdate),
            "worktree.close" => Ok(Self::WorktreeClose),
            "worktree.reorder" => Ok(Self::WorktreeReorder),
