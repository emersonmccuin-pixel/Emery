...
export function areWorkItemListsEqual(left: WorkItemRecord[], right: WorkItemRecord[]) {
  if (left.length !== right.length) {
    return false
  }
...
export function areDocumentListsEqual(left: DocumentRecord[], right: DocumentRecord[]) {
  if (left.length !== right.length) {
    return false
  }
...
export function areSessionRecordListsEqual(left: SessionRecord[], right: SessionRecord[]) {
  if (left.length !== right.length) {
    return false
  }
...
export function areSessionEventListsEqual(left: SessionEventRecord[], right: SessionEventRecord[]) {
  if (left.length !== right.length) {
    return false
  }
...
export function areCleanupCandidateListsEqual(left: CleanupCandidate[], right: CleanupCandidate[]) {
  if (left.length !== right.length) {
    return false
  }
