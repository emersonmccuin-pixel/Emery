use super::{
    ...
    UpdateProjectWorkflowSettingsInput, UpdateWorkItemInput, UpsertWorktreeRecordInput,
    ...
    pub fn update_project_workflow_settings(
        ...
        project_store::update_record(
            ...
            UpdateProjectInput {
                ...
                system_prompt: None,
                base_branch: None,
                default_workflow_slug: Some(input.default_workflow_slug.unwrap_or_default()),
            },
        )
    }
