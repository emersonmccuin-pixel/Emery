# Emery Tauri Client Architecture

## Purpose

This document defines the Emery v1 Tauri client architecture on top of the already-locked supervisor-backed core.
...
Emery v1 should treat the Tauri client as a thin but capable reconnecting workspace shell.
...
If the client holds this boundary, Emery can evolve into a richer IDE-like product without repeating Forge's UI-owned backend mistakes.
